...
// MARK: - Views
extension MCalendarView.Config {
    public func createCustomMonthLabel(_ builder: @escaping (Date, MCalendar) -> some MonthLabel) -> Self { changing(path: \.monthLabel, to: builder) }
...
extension MCalendarView { public struct Config: Configurable { public init() {}
    ...
    private(set) var monthLabel: (Date, MCalendar) -> any MonthLabel = DefaultMonthLabel.init
